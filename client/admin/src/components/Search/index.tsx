...
const Search = (props: Iprops) => {
    ...
    return (
        <div className="w-full relative ">
            ...
            <input
                type="search"
                className="w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-primary-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
